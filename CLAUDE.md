...
- After meaningful repo work in an enabled project, add an entry with `npm run closeout`.
- Use `npm run log:add` when repo state should not be inferred, such as planning-only notes or cross-repo summaries.
